...
class Backbone(nn.Module):
    ...
    def __init__(self,
        ...
        #self.layer4 = self._make_layer(block, 384, layers[2], stride=(2, 2, 2), norm_cfg=norm_cfg, activation_cfg=activation_cfg, weight_std=weight_std)
        self.layers = []
#192,384,384
...
if __name__=='__main__':
    ...
    import torch
    x = torch.ones(4, 1,8, 224, 224).cuda() #batchsize, channel,depth, h,w
